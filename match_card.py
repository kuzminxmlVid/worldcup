...
def build_match_card(row, tz: ZoneInfo) -> str:
    ...
    flag_font = _font(FONT_REGULAR, 58)
    ...
    draw.text((width - 120 - draw.textlength(stage, font=stage_font), 95), stage, font=stage_font, fill=(176, 196, 225))
    ...
    if left_flag:
        draw.text((190, 330), left_flag, font=flag_font, fill=(255, 255, 255))
    if right_flag:
        draw.text((960, 330), right_flag, font=flag_font, fill=(255, 255, 255))

    draw.multiline_text((190, 420), left_name, font=team_font, fill=(255, 255, 255), spacing=6)
    draw.multiline_text((960, 420), right_name, font=team_font, fill=(255, 255, 255), spacing=6)
